...
export class AdministradorController {
  ...
  async AutenticarAdministrador(@requestBody() credenciales: Credenciales) {
    let Administrador = await this.servicioAutenticacion.IdentificarAdministrador(
      credenciales.Usuario,
      credenciales.Password,
    );
    if (Administrador) {
      let token = this.servicioAutenticacion.GenerarTokenAdministradorJWT(Administrador);
      return {
        datos: {
