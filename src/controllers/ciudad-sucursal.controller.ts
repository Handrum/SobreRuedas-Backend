...
export class CiudadSucursalController {
  ...
  async find(
    ...
    return this.ciudadRepository.sucursals(id).find(filter);
  }
  ...
  async create(
    ...
    return this.ciudadRepository.sucursals(id).create(sucursal);
  }
  ...
  async patch(
    ...
    return this.ciudadRepository.sucursals(id).patch(sucursal, where);
  }
  ...
  async delete(
    ...
    return this.ciudadRepository.sucursals(id).delete(where);
  }
}
